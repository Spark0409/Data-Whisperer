BASE_PATH="."
METHOD=datawhisperer  # Support: datawhisperer, random, heuristic
GPUS=1
...
# Random & Heuristic specific settings
KEEP_RATIO=0.5        # Proportion of data to keep (for random and heuristic methods)
HEURISTIC=length      # Heuristic strategy: length, answer_length, quality_score, dedup
KEEP_LONG=true        # For heuristic: keep long samples (true) or short samples (false)
SIMILARITY_THRESHOLD=0.8  # For dedup heuristic: Jaccard similarity threshold (0.0-1.0)
